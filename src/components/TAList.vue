    ...
    <div class="shadow-box mb-3">
        <div class="list-header">
            ...
            <div class="header-filter">
                <TAListFilter :filterState="filterState" @update-filter="updateFilter" />
            </div>
...
import TAListItem from "../components/TAListItem.vue";
import TAListFilter from "./TAListFilter.vue";
