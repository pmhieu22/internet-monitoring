...
describe("Test parseCertificateInfo", () => {
    it("should handle undefined", async () => {
        const parseCertificateInfo = utilServer.__getPrivateFunction(
    ...
    it("should handle normal cert chain", async () => {
        ...
        const chain1 = {
            fingerprint:
                "CF:2C:F3:6A:FE:6B:10:EC:44:77:C8:95:BB:96:2E:06:1F:0E:15:DA",
...
describe("Test Discord Notification Provider", () => {
    ...
    const sendNotification = async (hostname, port, type) => {
        ...
        await discordProvider.send(
            {
                discordUsername: "V486 Monitoring",
    ...
    it.each(["dns", "port", "steam"])(
        "should send hostname for %p monitors",
        async (type) => {
...
describe("Test uptimeKumaServer.getClientIP()", () => {
    it("should able to get a correct client IP", async () => {
        ...
        fakeSocket.client.conn.request.headers["x-forwarded-for"] =
            "10.10.10.10";
