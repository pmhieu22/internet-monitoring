...
"echo" "-e" "====================="
"echo" "-e" "V486 Monitoring Install Script"
"echo" "-e" "====================="
...
"echo" "-e" "---------------------------------------"
"echo" "-e" ""
"echo" "-e" "Local - Install V486 Monitoring on your current machine with git, Node.js and pm2"
"echo" "-e" "Docker - Install V486 Monitoring Docker container"
"echo" "-e" ""
if [ "$1" != "" ]; then
  type="$1"
else
